...
case class InsertTupleseqStatement(base: Ident, columns: Seq[Ident], tupleseq: TupleseqExpression) extends StatementAST
...
case class GroupingRelationExpression(relation: RelationExpression,
    ...
    extends RelationExpression
case class SortedRelationExpression(relation: RelationExpression, exprs: List[(ValueExpression, Int, Int)])
    extends RelationExpression
...
case class LikeLogicalExpression(left: ValueExpression,
...
case class InLogicalExpression(expr: ValueExpression, negated: Boolean, list: List[ValueExpression])
    extends LogicalExpression
case class InQueryLogicalExpression(expr: ValueExpression, negated: Boolean, tuples: TupleCollectionExpression)
    extends LogicalExpression

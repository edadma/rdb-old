...
case class GroupingRelationExpression( relation: RelationExpression, discriminator: List[ValueExpression], cpos: Position, columns: List[ValueExpression] ) extends RelationExpression

...
case class GroupingRelationExpression( relation: RelationExpression, discriminator: List[ValueExpression], columns: List[ValueExpression] ) extends RelationExpression

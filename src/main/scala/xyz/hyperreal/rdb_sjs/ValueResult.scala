...
case class LiteralValue(pos: Position,
                        table: String,
                        heading: String,
                        typ: Type,
                        value: Any)
...
case class FieldValue(pos: Position,
                      ...
                      depth: Int)
    extends ValueResult
case class MarkedValue(pos: Position,
                       table: String,
                       heading: String,
                       typ: Type,
                       m: Mark)
...
case class ScalarFunctionValue(pos: Position,
                               ...
                               args: List[ValueResult])
    extends ValueResult
case class UnaryValue(pos: Position,
                      table: String,
                      heading: String,
                      typ: Type,
                      v: ValueResult,
                      operation: String)
    extends ValueResult
case class LogicalValue(pos: Position,
                        table: String,
                        heading: String,
                        typ: Type,
                        logical: LogicalResult)
    extends ValueResult
case class AliasValue(pos: Position,
                      table: String,
                      heading: String,
                      typ: Type,
                      apos: Position,
